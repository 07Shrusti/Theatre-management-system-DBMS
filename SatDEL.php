...
die($con->connect_error);
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql_delete = "delete from theatre where T_ID=$id";
        ...
        {
            echo '<script>alert("Select theater is deleted")</script>';
        }
    }
?>
...
<body>
<?php
    include("t_delete_html.php");
    ?>
    <form method="POST">
         <label>Theater ID to delete :</label>
